...
This is an Oreilly Downloader based on their v2 API. It was rewritten from the minified JS code in the [MyOnlineLearning Downloader](https://my-chrome-extensions.com/) extension - credits to the author for making it! I wrote it with 0 knowledge in both HTML and JavaScript (no offense but webdev is boring af). It seems to work for everything but PDF's adapted to xHTML format. I'm trying to fix that problem, though. AI was consulted for specific utilization of methods, NO CODE IS WRITTEN BY IT!
