...
## Usage
```bash
usage: orlydl.py [-h] [-i IDEN [IDEN ...]] [-m [FILE_LIST]] [-c [COOKIE_FILE]] [-o [OUTPUT_DIR]] [-t THREADS_NUM]
...
## Contributing
If you know Python--since it's relatively easy to learn--I encourage you to contribute. This repo was made with a goal of having people maintain new Pythonic code, of which the original Safaribooks currently isn't. 

### Why stay with Python?
The answer is simple: to allow more people to help develop the tool. That has been one of the purposes after seeing the stacked amount of PRs in Safaribooks.
